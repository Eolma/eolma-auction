...
public interface AuctionCachePort {
    ...
    Mono<Void> updateBidState(Long auctionId, Long currentPrice, String winnerId, int bidCount);

    Mono<Void> addBidToRanking(Long auctionId, String bidderId, Long amount);
    ...
    Mono<Boolean> setInstantBuyReservation(Long auctionId, String buyerId);
